...
\begin{figure}[h]
    \centering
    \includegraphics[width=.8\textwidth]{images/mandelaexample.PNG}
    %\caption{Caption}
    \label{fig:my_label}
\end{figure}
...
\section{Annexes}
Ramani Huria Data Model

Ramani Huria Cookbook
...
Technical Overview of Digital Assets
