...
\begin{tikzpicture}[remember picture,overlay] \node at (current page.center) {\includegraphics[width=\paperwidth,height=\paperheight]{images/CoverPage3.pdf}};
\end{tikzpicture}
\clearpage
...
\thispagestyle{empty}
\begin{tikzpicture}[remember picture,overlay] \node at (current page.center) {\includegraphics[width=\paperwidth,height=\paperheight]{images/ForewordPic.png}};
\end{tikzpicture}
\clearpage
...
\begin{tabular}{|c@{}c|}
	\hline
	\includegraphics[width=0.4\textwidth]{images/overview_buildings.JPG}&%
	\includegraphics[width=0.4\textwidth]{images/overview_highway.JPG}\\
	\hline
\end{tabular}
\end{center}
...
\newpage
\thispagestyle{empty}
\begin{tikzpicture}[remember picture,overlay] \node at (current page.center) {\includegraphics[width=\paperwidth,height=\paperheight]{LVC_Drone_Flying_2018_Sala_Lewis_328.JPG}};
\end{tikzpicture}
\clearpage
